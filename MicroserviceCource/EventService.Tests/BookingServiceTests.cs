...
public class BookingServiceTests
{
    ...
    // В чате по проекту ответа нет, поэтому спрошу здесь.
    // Какое ожидаемое поведение если несколько броней на одно событие? Ведь проверка количества мест будет только в 4 спринте.
    // Так же в задании не было указано что бронь можно отменить, поэтому будто и некуда ставить Rejected. Тогда как это проверить?
    // А так же в чем отличие брони для удаленного события и не существующего?
